...
const OfPrint = () => {
  ...
  function generateControlNumber() {
    ...
    return `Of${randomNumber.toString().padStart(2, '0')}`;
  }
        ...
        <div className='yellowbox'>
          <div className='link'>citu@imprs.com</div>
            ...
            <div className='requestform'>
                ...
                <h2 className='type'>OFFICE FORM PRINTING REQUEST FORM</h2>
                <div className='control-prop'>
                    <h1 className='control'>Request Control #:</h1>
                    <div className='control-number'>{controlNumber}</div>
                </div>

                <h1 className='print-details'>Office Forms Printing Details:</h1>
                <div className='file-prop'>
                    <h1 className='file-name'>Office Form File Name:</h1>
                    <input
                    type="file"
