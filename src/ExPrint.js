...
const ExPrint = () => {
  ...
  function generateControlNumber() {
    ...
    return `Ex${randomNumber.toString().padStart(2, '0')}`;
  }
        ...
        <div className='yellowbox'>
          <div className='link'>citu@imprs.com</div>
            ...
            <div className='requestform'>
                ...
                <h2 className='type'>EXAMINATION PRINTING REQUEST FORM</h2>
                <div className='control-prop'>
                    <h1 className='control'>Request Control #:</h1>
                    <div className='control-number'>{controlNumber}</div>
                </div>

                <h1 className='print-details'>Examination Printing Details:</h1>
                <div className='file-prop'>
                    <h1 className='file-name'>Examination File Name:</h1>
                    <input
                    type="file"
                ...
                <div className='print-det-prop'>
                    <h1 className='file-name'>Give the Examination File Personally:</h1>
                    <div>
                        <label>
                            <input
                                type="radio"
            ...
            <div className='size-box' onClick={() => setShowPaperSizeDropdown(!showPaperSizeDropdown)}>
            ...
            {showPaperSizeDropdown && (
                <div className='dropdown-content'>
                    {paperSizes.map((size, index) => (
                        ...
                        <div className='print-det-prop'>
                            <h1 className='file-name'>Staple:</h1>
                            <div>
                                <label>
                                    <input
                                        type="radio"
